...
try{
	...
	// ChDKZ_Unit_Configs = "getText (_x >> 'faction') == 'LOP_ChDKZ' && getText (_x >> 'simulation') == 'soldier'" configClasses (configFile >> "CfgVehicles");

	// ChDKZ = ChDKZ_Unit_Configs apply {configName _x};
} 
catch {
	hint str _exception;
};

/*
				***		ARMA3Alpha REINFORCEMENT CHOPPER SCRIPT v1.81 - by SPUn / lostvar	***
		...
		Calling the script:
			...
			custom: 		nul = [spot,exact,side,type,captive,patrol,target,direction,distance,precise,
								cycle,groupSize,skills,smoke,group,custom init,ID,MP] execVM "reinforcementChopper.sqf";
...
_BLUmen = [
"B_mas_usn_Soldier_F",
"B_mas_usn_Soldierm_F",
"B_mas_usn_Soldier_02_f",
"B_mas_usn_Soldier_03_f",
"B_mas_usn_Soldier_GL_F",
"B_mas_usn_Soldier_JTAC_F",
"B_mas_usn_soldier_AR_F",
"B_mas_usn_soldier_MG_F",
"B_mas_usn_Soldier_lite_F",
"B_mas_usn_Soldier_off_F",
"B_mas_usn_Soldier_SL_F",
"B_mas_usn_soldier_M_F",
"B_mas_usn_soldier_Mh_F",
"B_mas_usn_soldier_LAT_F",
"B_mas_usn_medic_F",
"B_mas_usn_soldier_repair_F",
"B_mas_usn_soldier_exp_F",
"B_mas_usn_Soldier_TL_F_rec",
"B_mas_usn_Soldier_F_rec",
"B_mas_usn_Soldier_AR_F_rec",
"B_mas_usn_soldier_exp_F_rec",
"B_mas_usn_soldier_LAT_F_rec",
"B_mas_usn_soldier_LAA_F_rec",
"B_mas_usn_medic_F_rec",
"B_mas_usn_soldier_M_F_rec",
"B_mas_usn_soldier_Mh_F_rec",
"B_mas_usn_Soldier_F_recn",
"B_mas_usn_Soldier_AR_F_recn",
"B_mas_usn_soldier_exp_F_recn",
"B_mas_usn_soldier_LAT_F_recn",
"B_mas_usn_soldier_LAA_F_recn",
"B_mas_usn_medic_F_recn",
"B_mas_usn_soldier_M_F_recn",
"B_mas_usn_soldier_Mh_F_recn"
...
"O_mas_afr_Soldier_TL_Fn",
"O_mas_afr_soldier_M_F",
"O_mas_afr_soldier_LAT_F",
"O_mas_afr_soldier_AT_F",
				...
				if((_targetMarker select 0) == "PATROL")then{ ////USE patrol-vD.sqf
					{
						...
						nul = [_x,_cPosition,_cRadius,_doorHandling] execVM "patrol-vD.sqf";
					}forEach units _grp2;
				};
			};

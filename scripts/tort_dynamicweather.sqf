...
if (isNil "tort_rainthread_handle") then {
   tort_rainthread_handle = [_rainmin,_rainmax,tort_seed] execVM "\@tort_DynamicWeather\script\tort_rainthread.sqf";
};
if (isNil "tort_windthread_handle") then {
   tort_windthread_handle = [(random (5*windstr)) - (10*windstr), (random (5*windstr)) - (10*windstr), tort_seed] execVM "\@tort_DynamicWeather\script\tort_windthread.sqf";
};

/*
if (isNil "tort_pp_handle") then {
   tort_pp_handle = [tort_seed] execVM "\@tort_DynamicWeather\script\tort_pp.sqf";
};
*/
